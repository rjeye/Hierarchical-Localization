...
# based on https://github.com/cvg/Hierarchical-Localization/pull/340/files
# itself based on https://github.com/hugoycj/light-hloc/blob/e518dbaa06b6b57e5663318cff237066ac26bd08/lighthloc/associators/pairs_from_sequance.py
...
def main(
    ...
    # TODO: remove duplicate matches at the end of the extend sequence
    if assume_loop:
        names_q += names_q[:overlap]
...
if __name__ == "__main__":
    ...
    parser.add_arguments(
        "--assume_loop",
        action="store_true",
        help="Whether to assume the sequence is a loop (last image is connected to the first).",
    )
